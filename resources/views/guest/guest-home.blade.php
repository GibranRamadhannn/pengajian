...
<div class="flex flex-col justify-center text-center gap-6 p-3">
    ...
    <div class="mt-6">
        ...
        <h1 class="font-bold text-2xl text-white" style="text-shadow: 1px 1px #000">BANDUNG 1446</h1>
    </div>
    <!-- Header Text end -->
</div>
@endsection
...
<div class="flex flex-col justify-center text-center gap-6 p-4">
    ...
    <div class="inline-flex justify-center">
        <svg id="SvgjsSvg1028" width="50" height="50" xmlns="http://www.w3.org/2000/svg" version="1.1"
            xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs">
            <defs id="SvgjsDefs1029"></defs>
            <g id="SvgjsG1030" transform="matrix(1,0,0,1,0,0)"><svg xmlns="http://www.w3.org/2000/svg"
                    data-name="Layer 1" viewBox="0 0 32 32" width="50" height="50">
                    <path fill="#ffffff"
                    ...
                    <path fill="#2c2b2d"
                        ...
                        class="color2c2b2d svgShape"></path>
                    <rect width="3" height="10" x="14.5" y="21.5" fill="#8b8891" class="color8b8891 svgShape"></rect>
                    <path fill="#2c2b2d"
        ...
        <a href="{{ route('participant.create', 'L') }}"
            class="rounded-full bg-blue-700 px-6 py-2.5 text-lg font-bold text-white shadow-sm hover:bg-blue-200 hover:text-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">saya
            IKHWAN</a>
    </div>
    ...
    <div class="inline-flex justify-center">
        <a href="{{ route('participant.create', 'P') }}"
            class="rounded-full bg-pink-600 px-6 py-2.5 text-lg font-bold text-white shadow-sm hover:bg-pink-200 hover:text-pink-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">saya
            AKHWAT</a>
        <svg id="SvgjsSvg1016" width="50" height="50" xmlns="http://www.w3.org/2000/svg" version="1.1"
            xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs">
            <defs id="SvgjsDefs1017"></defs>
            <g id="SvgjsG1018"><svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 512 512"
                    ...
                    <path fill="#ff6699" d="M491.9,431.5v53.8c0,11.8-9.6,21.4-21.4,21.4h-429c-11.8,0-21.4-9.6-21.4-21.4v-53.8c0-70.7,57.3-128,128-128
                        h215.7C434.6,303.5,491.9,360.8,491.9,431.5z" class="colorc9d2d7 svgShape"></path>
                    <path fill="#ff6699"
                    ...
                    <path fill="#393838" d="M413.6,307.9c-50.3-201.3-57.4-229.2-63.5-253.6C340.6,22.1,304.4,0.7,258,0c-83.3-1.2-95.6,54.2-96.1,54.6
